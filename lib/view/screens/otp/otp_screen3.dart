...
class OtpScreen3 extends StatefulWidget {
  ...
  const OtpScreen3({Key? key, required this.phoneNumber}) : super(key: key);
  @override
  OtpScreen3State createState() => OtpScreen3State();
}

class OtpScreen3State extends State<OtpScreen3> {
  String _code = "";
